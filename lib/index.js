...
function _setDefaultOptions(options) {
	...
	return _copyProperties({
		...
		'ignoreList': globListToRegX(options.ignoreList),
		'fileExtensions': globListToRegX(options.fileExtensions)
	}, options);
}
